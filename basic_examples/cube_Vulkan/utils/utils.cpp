  ...
  namespace su
  {
                                         ...
                                         vk::CompareOp                                                       compareOp)
    {
      ...
      vk::PipelineDepthStencilStateCreateInfo pipelineDepthStencilStateCreateInfo(
        vk::PipelineDepthStencilStateCreateFlags(), depthBuffered, depthBuffered, compareOp, false, false, stencilOpState, stencilOpState );
...
*/
      vk::InstanceCreateInfo instInfo({}, &applicationInfo, 0, nullptr, uint32_t(extensions.size()), extensions.data());
      vk::Instance instance = vk::createInstance( instInfo );
      //vk::Instance instance = vk::createInstance( makeInstanceCreateInfoChain( {}, applicationInfo, enabledLayers, extensions ).get<vk::InstanceCreateInfo>() );
    ...
    SurfaceData::SurfaceData( vk::Instance const & instance, std::string const & windowName, vk::Extent2D const & extent_, WindowData &w )
      : extent( extent_ ), window(w)
    {
