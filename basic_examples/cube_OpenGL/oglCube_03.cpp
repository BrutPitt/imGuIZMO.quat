...
int main()
{
    ...
    ///////////////////////////////////
    imguiGizmo::setGizmoFeelingRot(3.5f);           // default 1.0, >1 more mouse sensitivity, <1 less mouse sensitivity
    imguiGizmo::setPanScale(5.0f);                  // default 1.0, >1 more, <1 less
    imguiGizmo::setDollyScale(5.0f);                // default 1.0, >1 more, <1 less
    ...
    ///////////////////////////////////
        static quat rotation;                           // quat default constructor initialize @ quat(1,0,0,0) ==> w(1) x(0) y(0) z(0), w is left/first value
